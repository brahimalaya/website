...
browse._magazine.templates={
	...
	defaultheader:{file:"issues/common/templates/nge/default-header.html"},
	 ...
	 * NGE Specials
	 */
	productcover:{file:"issues/common/templates/nge/product_cover.html"},	
	productslide1:{file:"issues/common/templates/nge/prodslides/productslide1.html"},
	productpresentation:{file:"issues/common/templates/nge/prodslides/productpresentation.html"},
	product3d:{file:"issues/common/templates/nge/prodslides/product3d.html"},
	productsupport:{file:"issues/common/templates/nge/prodslides/productsupport.html"},
	productorder:{file:"issues/common/templates/nge/prodslides/productorder.html"},
				...
				articles:{
					...
					rollingstart:[
						// Each item of this array is an article. Each article has a title, a subtitle and a set of pages.
						{
							...
							pages:['product1order', 'product1support','contact']
						}
					],
				}
			}
...
browse._magazine.data={
	 ...
	 * NGE PAGES
	 */
	product1presentation:{
		// You can specify a stack of page templates, defined into browse._magazine.templates.
		template:["defaultheader","productpresentation"],
		// These placeholders are replaced from the page once the layers are stacked.
		//placeholders:"issues/demo-issue/articles/nge/productslide1.txt",
	},
	product13d:{
		// You can specify a stack of page templates, defined into browse._magazine.templates.
		template:["defaultheader","product3d"],
		// These placeholders are replaced from the page once the layers are stacked.
		//placeholders:"issues/demo-issue/articles/nge/productslide1.txt",
	},
	product1order:{
		// You can specify a stack of page templates, defined into browse._magazine.templates.
		template:["defaultheader","productorder"],
		// These placeholders are replaced from the page once the layers are stacked.
		//placeholders:"issues/demo-issue/articles/nge/productslide1.txt",
	},
	product1support:{
		// You can specify a stack of page templates, defined into browse._magazine.templates.
		template:["defaultheader","productsupport"],
		// These placeholders are replaced from the page once the layers are stacked.
		//placeholders:"issues/demo-issue/articles/nge/productslide1.txt",
	},
