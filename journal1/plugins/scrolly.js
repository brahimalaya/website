...
browse._widgets.scrolly={
	global: {
		...
		keepcoord:function(ctx) {
			...
			//this.autoScroll();
			//window.setTimeout('this.autoScroll()',1000);
			//window.setInterval(function(){this.autoScroll()},3000);
		},
		autoScroll:function(){
			var obj1=document.getElementById("page_row_1").height;
			alert("heightapDiv1= "+obj1);
			//var div = document.getElementById("page_row_" + #vertical#);
			//document.getElementById("page_row_1").style.fontWeight = 'bold';
			//alert(document.getElementById("page_row_1").);
		},
		keepview:function() {
			var ctx=widget.getcontext(this);
			this.keepcoord(ctx);
		...
		isidle:function() { 
			var ctx=widget.getcontext(this); return !this._springing},
		// Touch
